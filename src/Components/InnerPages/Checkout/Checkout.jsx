...
const Checkout = () => {
  ...
  var total = 0;
  var shipping = 199;
// feedback: fw17_0058 and fw20_0209 - use reduce method instead of for loop
            ...
            {cartData.map((e) => {
              return (
                <>
                  {/* <p>{e.name}</p> */}
                  {/* <p>Free</p> */}
                  <img className={styles.image} src={e.thumbnail} alt = "MATRIX"/>
                  <p>{e.price.raw}</p>
                </>
              );
            })}
...
{/* 
          ...
          <div className={styles.review1}>
            <div className={styles.review12}>
              {/* <p className={styles.size}>Review</p> */}
        ...
        <div className={styles.rigth}>
          ...
          <div className={styles.review2}>
            <div className={styles.flex}>
              {/* feedback: fw17_0058 and fw20_0209 - Don't use encoded image directly*/}
              <img
            ...
            <p>
              Big Brothers Big Sisters served 109,254 {"\n"} children in 2020,
            ...
            <div className={styles.flex}>
              <div>
                <input type="checkbox" />
                <label className={styles.bold}>Donate $5.00</label>
              </div>
              <div>
                <input type="checkbox" />
                <label className={styles.bold}>Donate $5.00</label>
            ...
            <p className={styles.last}>
              ...
              for tax deductions. 100% of your donation goes to {"/n"}.
