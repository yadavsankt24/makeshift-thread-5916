    ...
    <Box bg="gray.100" p="40px 0px">
      <Box w="90%" m="auto">
        ...
        >
          <Box display="grid" gridTemplateColumns="repeat(1, 1fr)" gap="10px">
            ...
            <Link fontWeight="400" fontSize="15px">
              Contact Us
            </Link>
            <Link fontWeight="400" fontSize="15px">
              Order Status
          ...
          <Box>
            <Link
              ...
              mb="15px"
            >
              <Icon color="gray.600" as={FcSmartphoneTablet} w={7} h={7} /> Get
              our apps
            </Link>
            <Box>
              <Image
      ...
      <Box w="90%" m="auto" mt="40px">
        <Box
          ...
          alignItems="center"
        >
          <Link fontWeight="400" fontSize="13px">
            Privacy
          </Link>
          <Link fontWeight="400" fontSize="14px">
